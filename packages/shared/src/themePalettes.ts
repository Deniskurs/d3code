...
// Keep the stored theme ID so existing selections adopt the Devis palette.
export const T3_CHAT_THEME: ThemeDefinition = {
  id: "t3-chat",
  label: "D3 Devis Special",
  appearance: "light",
  colors: {
    canvas: "oklch(0.980268 0.022321 87.149)",
    chrome: "oklch(0.96288 0.028045 86.645)",
    toolbar: "oklch(0.96288 0.028045 86.645)",
    toolbarForeground: "oklch(0.339493 0.070328 261.829)",
    toolbarBorder: "oklch(0.863903 0.019761 90.56)",
    toolbarControl: "oklch(0.945966 0.014121 268.491)",
    toolbarControlForeground: "oklch(0.358437 0.081116 263.575)",
    toolbarControlHover: "oklch(0.920497 0.026352 264.437)",
    surface: "oklch(0.962817 0.019981 84.59)",
    surfaceRaised: "oklch(0.993928 0.008183 91.48)",
    surfaceOverlay: "oklch(0.994198 0.006926 88.641)",
    text: "oklch(0.31948 0.075728 263.542)",
    textMuted: "oklch(0.49064 0.043865 261.922)",
    border: "oklch(0.886225 0.019984 87.521)",
    input: "oklch(0.824215 0.036648 262.798)",
    focus: "oklch(0.458722 0.202727 263.675)",
    accent: "oklch(0.458722 0.202727 263.675)",
    accentForeground: "oklch(0.983243 0.018271 86.145)",
    secondary: "oklch(0.942498 0.015771 266.277)",
    secondaryForeground: "oklch(0.379891 0.080515 263.012)",
    muted: "oklch(0.932415 0.017279 84.588)",
    mutedForeground: "oklch(0.488644 0.042983 264.783)",
    placeholder: "oklch(0.544919 0.04327 265.538)",
    secondaryLabel: "oklch(0.49064 0.043865 261.922)",
    iconMuted: "oklch(0.49064 0.043865 261.922)",
    error: "oklch(0.522628 0.167648 18.185)",
    errorForeground: "oklch(0.456689 0.14799 17.086)",
    errorSurface: "oklch(0.946179 0.022295 27.812)",
    warning: "oklch(0.556789 0.115703 66.788)",
    warningForeground: "oklch(0.476851 0.096715 65.875)",
    warningSurface: "oklch(0.947849 0.041387 88.795)",
    update: "oklch(0.458722 0.202727 263.675)",
    updateForeground: "oklch(0.412948 0.125096 262.185)",
    updateSurface: "oklch(0.945426 0.025783 266.61)",
    accentSurface: "oklch(0.945815 0.017029 267.789)",
    accentSurfaceForeground: "oklch(0.380197 0.105743 263.654)",
    messageSurface: "oklch(0.945815 0.017029 267.789)",
    messageForeground: "oklch(0.358437 0.081116 263.575)",
    messageAction: "oklch(0.458722 0.202727 263.675)",
    messageActionForeground: "oklch(0.983243 0.018271 86.145)",
    messageActionHover: "oklch(0.397488 0.179062 263.9)",
    codeBackground: "oklch(0.955042 0.007029 268.547)",
    codeForeground: "oklch(0.375408 0.090935 263.347)",
    sidebar: "oklch(0.939054 0.026993 85.665)",
    sidebarForeground: "oklch(0.338266 0.060955 262.293)",
    sidebarMutedForeground: "oklch(0.490215 0.042118 267.804)",
    sidebarControlSurface: "oklch(0.983243 0.018271 86.145)",
    sidebarRowHover: "oklch(0.937243 0.008351 271.325)",
    sidebarRowActive: "oklch(0.925935 0.023801 262.093)",
    sidebarRowSelected: "oklch(0.925935 0.023801 262.093)",
    sidebarBorder: "oklch(0.870328 0.018446 89.371)",
    terminalBackground: "oklch(0.980268 0.022321 87.149)",
    terminalForeground: "oklch(0.31948 0.075728 263.542)",
    terminalCursor: "oklch(0.458722 0.202727 263.675)",
    terminalSelection: "oklch(0.920497 0.026352 264.437)",
    terminalScrollbar: "oklch(0.830989 0.028781 263.411)",
    terminalScrollbarHover: "oklch(0.686821 0.057987 262.103)",
  },
  variants: {
    dark: {
      canvas: "oklch(0.250989 0.069864 267.365)",
      chrome: "oklch(0.232277 0.063498 267.114)",
      toolbar: "oklch(0.232277 0.063498 267.114)",
      toolbarForeground: "oklch(0.959629 0.029284 87.544)",
      toolbarBorder: "oklch(0.409616 0.078797 263.901)",
      toolbarControl: "oklch(0.333521 0.079569 265.248)",
      toolbarControlForeground: "oklch(0.923929 0.027096 85.666)",
      toolbarControlHover: "oklch(0.406615 0.086349 263.009)",
      surface: "oklch(0.301655 0.075844 264.893)",
      surfaceRaised: "oklch(0.333521 0.079569 265.248)",
      surfaceOverlay: "oklch(0.289238 0.072753 265.012)",
      text: "oklch(0.971926 0.031989 87.288)",
      textMuted: "oklch(0.840953 0.020948 264.455)",
      border: "oklch(0.409616 0.078797 263.901)",
      input: "oklch(0.474062 0.078294 260.531)",
      focus: "oklch(0.826769 0.085861 264.874)",
      accent: "oklch(0.8874 0.068976 87.886)",
      accentForeground: "oklch(0.271154 0.064394 265.085)",
      secondary: "oklch(0.357046 0.073972 263.829)",
      secondaryForeground: "oklch(0.938474 0.021324 85.945)",
      muted: "oklch(0.334518 0.068911 265.204)",
      mutedForeground: "oklch(0.840953 0.020948 264.455)",
      placeholder: "oklch(0.762738 0.039652 265.764)",
      secondaryLabel: "oklch(0.840953 0.020948 264.455)",
      iconMuted: "oklch(0.840953 0.020948 264.455)",
      error: "oklch(0.736901 0.128513 13.435)",
      errorForeground: "oklch(0.860238 0.076523 12.735)",
      errorSurface: "oklch(0.319862 0.054345 332.207)",
      warning: "oklch(0.822462 0.099435 82.223)",
      warningForeground: "oklch(0.887531 0.082585 83.889)",
      warningSurface: "oklch(0.339736 0.020959 292.893)",
      update: "oklch(0.8874 0.068976 87.886)",
      updateForeground: "oklch(0.919522 0.055434 87.717)",
      updateSurface: "oklch(0.356457 0.068334 264.484)",
      accentSurface: "oklch(0.397697 0.089495 264.116)",
      accentSurfaceForeground: "oklch(0.958163 0.048337 87.57)",
      messageSurface: "oklch(0.348796 0.094704 264.711)",
      messageForeground: "oklch(0.962334 0.02646 87.853)",
      messageAction: "oklch(0.557008 0.172163 265.486)",
      messageActionForeground: "oklch(0.983503 0.017058 84.587)",
      messageActionHover: "oklch(0.507857 0.169724 265.628)",
      codeBackground: "oklch(0.223286 0.062199 266.681)",
      codeForeground: "oklch(0.884576 0.039573 87.568)",
      sidebar: "oklch(0.223286 0.062199 266.681)",
      sidebarForeground: "oklch(0.966816 0.036396 86.173)",
      sidebarMutedForeground: "oklch(0.825423 0.031448 265.299)",
      sidebarControlSurface: "oklch(0.305609 0.077674 264.439)",
      sidebarRowHover: "oklch(0.332203 0.078379 264.235)",
      sidebarRowActive: "oklch(0.388207 0.09308 264.5)",
      sidebarRowSelected: "oklch(0.388207 0.09308 264.5)",
      sidebarBorder: "oklch(0.390911 0.074077 264.378)",
      terminalBackground: "oklch(0.232277 0.063498 267.114)",
      terminalForeground: "oklch(0.953372 0.030553 88.374)",
      terminalCursor: "oklch(0.8874 0.068976 87.886)",
      terminalSelection: "oklch(0.412163 0.092666 263.483)",
      terminalScrollbar: "oklch(0.442424 0.080902 263.961)",
      terminalScrollbarHover: "oklch(0.58751 0.080721 264.003)",
    },
  },
  sidebarArtwork: true,
};
