...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "d3code-dev" : "d3code";
  const legacyUserDataDirName = isDevelopment ? "D3 Code (Dev)" : "D3 Code (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.deniskurs.d3code.dev" : "com.deniskurs.d3code",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "d3code-dev" : "d3code",
