...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's D3CODE_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus D3CODE_HOME (dev-runner
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus D3CODE_HOME; pass it
