...
export const AGENT_NOTIFICATION_SHOW_CHANNEL = "desktop:agent-notification-show";
export const AGENT_NOTIFICATION_DISMISS_CHANNEL = "desktop:agent-notification-dismiss";
