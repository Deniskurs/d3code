...
import * as AgentNotificationIpc from "./methods/agentNotifications.ts";
...
export const installDesktopIpcHandlers = Effect.fn("desktop.ipc.installHandlers")(function* () {
  ...
  yield* ipc.handle(AgentNotificationIpc.show);
  yield* ipc.handle(AgentNotificationIpc.dismiss);
