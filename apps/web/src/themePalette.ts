...
/**
 * The palette D3 Code wears with no theme installed, captured from the app's
...
/**
 * The standard D3 Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors D3 Code shows without a theme, read from the app's own
