...
/**
 * The skew a user can act on: the connected server runs an older D3 Code than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same D3 Code version.",
  };
}
