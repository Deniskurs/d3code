...
const BRAND_MARK_SOURCE =
  appVariant === "development"
    ? require("../../../../assets/devis/dev/icon.png")
    : appVariant === "preview"
      ? require("../../../../assets/devis/nightly/icon.png")
      : require("../../../../assets/devis/prod/icon.png");
    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-t3-bold tracking-[-0.4px] text-foreground">D3 Code</Text>
